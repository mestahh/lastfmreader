...
public class RestReaderTest {
	...
	public void returns_artist_info() throws IOException {
		String answer = restReader
				.getAnswer("method=artist.getinfo&artist=Cher&api_key=37be6c106e0df038465a880c7b65b15b");
	...
	public void returns_similar_artists() throws IOException {
		String answer = restReader
				.getAnswer("method=artist.getsimilar&artist=cher&api_key=37be6c106e0df038465a880c7b65b15b");
		System.out.println(answer);
	}
